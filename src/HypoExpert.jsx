...
function Intro({ onStart, data, update }) {
  ...
  return (
    <div className="animate-in pt-4">
      ...
      {/* Carte courtier */}
      <div className="flex items-center gap-4 bg-white border border-stone-200 rounded-2xl p-4 mb-6 shadow-sm">
        <img
          src="/ronny.jpg"
          alt="Ronny Aguilera"
          className="w-16 h-16 rounded-full object-cover object-top flex-shrink-0 ring-2 ring-blue-900/10"
        />
        <div className="flex-1 min-w-0">
          <div className="font-semibold text-slate-900 text-sm">Ronny Aguilera</div>
          <div className="text-xs text-slate-500">Courtier hypothécaire · Représentant autonome</div>
          <div className="flex items-center gap-1 mt-1.5">
            {[1,2,3,4,5].map(i => (
              <svg key={i} viewBox="0 0 20 20" className="w-3 h-3 fill-amber-400"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
            ))}
            <span className="text-xs text-slate-400 ml-1">Consultation gratuite</span>
          </div>
        </div>
      </div>
